  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm p-6 relative">
        ...
        <h2 className="text-xl font-bold text-purple-600 mb-1">Save as PDF</h2>
        ...
        {isGeneratingAll ? (
          ...
          <div className="mt-3 space-y-3">
            <p className="text-sm text-gray-500">
              <span className="font-semibold text-purple-600">{readyCount} of {totalCount} pages</span> have been generated so far.
            </p>

            {/* Option 1: Download now */}
            <button
              onClick={onDownloadNow}
              className="w-full py-3 px-4 border-2 border-purple-300 text-purple-600 font-semibold rounded-xl flex items-center gap-3 hover:bg-purple-50 transition-colors text-left"
            >
              <ArrowDownTrayIcon className="w-5 h-5 flex-shrink-0" />
              <div>
                <div className="text-sm font-bold">Download now</div>
                <div className="text-xs text-gray-400 font-normal">Save {readyCount} pages as PDF</div>
              </div>
            </button>
